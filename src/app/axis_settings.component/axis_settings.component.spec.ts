...
describe ('AxisSettingsComponent', () => {
  ...
  describe ('check methods', () => {
    ...
    describe ('reset', () => {
      ...
      it ('should on click call toggleSums of own state, setSettings and showResult', () => {
        spyOn (component, 'setSettings');
        spyOn (component, 'showResult');
        component.reset (new MouseEvent ('click'));
        expect (component.state.toggleSums).toHaveBeenCalled ();
        expect (component.setSettings).toHaveBeenCalled ();
    ...
    describe ('changeInputs', () => {
      it ('should call method toggleSums of own state property', () => {
        component.changeInputs ();
        expect (component.state.toggleSums).toHaveBeenCalled ();
      });
    });
  });
  ...
  describe ('check markup', () => {
    ...
    it ('should on click use-sums checkbox toggle state', fakeAsync (() => {
      ...
      expect (element.querySelector ('#maxSumValue') === null).toBeFalsy ();
